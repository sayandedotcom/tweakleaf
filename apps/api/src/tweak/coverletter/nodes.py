from src.tweak.coverletter.schemas import CoverLetterRequestSchema, CoverLetterStructuredOutput, CoverLetterStructuredOutputForUpdateUserContext, ChatMessage
from src.tweak.coverletter.prompts import system_prompt_to_update_user_context_for_coverletter, human_prompt_to_tweak_coverletter, system_prompt_to_tweak_coverletter
from src.services.latex_compiler import LatexCompilerService
from src.models.factory import ModelFactory
from src.tweak.utils.supabase_client import get_coverletter_context, update_coverletter_context
...
class CoverLetterNodes:
    def __init__(self): 
        self.latex_service = LatexCompilerService()
