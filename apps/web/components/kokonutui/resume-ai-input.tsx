...
import { HumanizedProButtonResume } from "@/components/humanized-pro-button-resume";
...
interface ResumeAiInputProps {
  ...
  isEmpty?: boolean;
  isPending?: boolean;
  handleStartResume?: () => void;
}

export function ResumeAiInput({
