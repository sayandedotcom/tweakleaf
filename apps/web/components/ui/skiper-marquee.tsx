...
const tiles = [
  {
    icon: llmModelsSvg.openai({
      className: "size-full",
    }),
    bg: (
      <div className="pointer-events-none absolute left-1/2 top-1/2 size-1/2 -translate-x-1/2 -translate-y-1/2 overflow-visible rounded-full bg-gradient-to-r"></div>
    ),
  },
  {
    icon: llmModelsSvg.anthropic({
      className: "size-full",
    }),
    bg: (
      <div className="pointer-events-none absolute left-1/2 top-1/2 size-1/2 -translate-x-1/2 -translate-y-1/2 overflow-visible rounded-full bg-gradient-to-r"></div>
  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        "bg-accent-foreground [box-shadow:0_0_0_1px_rgba(0,0,0,.03),0_2px_4px_rgba(0,0,0,.05),0_12px_24px_rgba(0,0,0,.05)]",
...
export function SkiperMarquee() {
  ...
  return (
    <section id="cta">
      <div className="container mx-auto px-1 py-2 md:px-2">
