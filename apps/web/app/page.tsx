...
export default function Home() {
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <div className="relative flex flex-col items-center justify-center h-[480px] bg-background pt-20">
      ...
      <div className="flex flex-row items-center justify-center mb-52 gap-4">
        <Link
          href="/tweak"
          className={cn(
            buttonVariants(),
